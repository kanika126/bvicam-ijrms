...
const Currentisssue = () => {
  return (
    ...
    <div className="w-full md:w-11/12 bg-white rounded-b-lg shadow-lg p-6 mt-4 hover:shadow-xl transition duration-300">
        <h2 className="text-2xl font-bold text-center  py-4">Current Issue<br></br><br></br>
        (July-December 2023 Vol.2 Issue 2)<br></br>
Editorial<br></br><br></br>
Table of Contents<br></br></h2>
      ...
      <table className="w-full md:w-2/3 lg:w-1/2 bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <tbody className="text-gray-600">
          <tr>
            ...
            <td className="border border-gray-300 py-2 px-4">Mental Health in CALD community and related stigmas for Muslim community</td>
            <td className="border border-gray-300 py-2 px-4">Saima Durrani</td>
          </tr>
          <tr>
            <td className="border border-gray-300 py-2 px-4">2.</td>
            <td className="border border-gray-300 py-2 px-4">Exploring the Potential of Metaverse in Software Engineering Education: A Conceptual Framework</td>
